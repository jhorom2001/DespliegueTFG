...
import dam2.TFG.Film24.modelo.PedidoAdminDTO;
...
public class ControladorAdmin {
	...
	public String listaPedidosAdmin(Model model) {
	    ...
	    List<PedidoAdminDTO> pedidosDTO = pedidos.stream().map(p -> {
	        ...
	        String nombreCompletoUsuario = p.getUsuario().getNombre() + " " + p.getUsuario().getApellido();
	...
	public String actualizarEstadoPedido(@RequestParam("pedidoId") int pedidoId,
	                                     @RequestParam("nuevoEstado") String nuevoEstado,
	                                     RedirectAttributes redirectAttributes) {
	    Pedido pedido = dao.buscarPedidoPorId(pedidoId);
	    ...
	    return "redirect:/listaPedidosAdmin";
	}
